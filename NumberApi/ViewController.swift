...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: TableViewCell.defaultIdentifier,
                                 bundle: nil),
                           forCellReuseIdentifier: TableViewCell.defaultIdentifier)
        initialFectch()
    }
...
extension ViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: TableViewCell.defaultIdentifier, for: indexPath) as! TableViewCell
